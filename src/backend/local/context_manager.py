...
class ContextManager():
    ...
    def __init__(self, project_root):
        try: 
            ...
            self.model = BartForConditionalGeneration.from_pretrained(sum_filepath, local_files_only=True)
            self.tokenizer = BartTokenizer.from_pretrained(sum_filepath, local_files_only=True)
