...
class TestCommandLineService:
    ...
    def test_print_text(self):
        ...
        with patch("builtins.print") as mock_print, \
             patch.object(self.cli_instance.term, "ljust", return_value="test"):
    ...
    def test_display_neon_title(self):
        ...
        with patch("pyfiglet.figlet_format", return_value="test"), \
             patch.object(self.cli_instance.term, "inkey", side_effect=[True, False]):
    ...
    def test_display_settings_menu_success(self):
        ...
        with patch("os.path.join", return_value="/mock/path/.env"), \
    ...
    def test_display_settings_menu_no_devices(self):
        ...
        with patch.object(self.cli_instance.logger, "error", mock_logger_error), \
             patch("time.sleep", return_value=None), \
    ...
    def test_display_cli(self, selection, function, parameter):
        ...
        with patch("builtins.input", side_effect=[selection, "q"]), \
             patch.object(self.cli_instance, function) as mock_function:
