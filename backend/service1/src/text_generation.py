...
llm_model_name = "TurkuNLP/gpt3-finnish-small"  # Replace with the specific model you want
llm_tokenizer = AutoTokenizer.from_pretrained(llm_model_name, padding_side='left', cache_dir="D:/.cache")
llm_model = AutoModelForCausalLM.from_pretrained(llm_model_name, cache_dir="D:/.cache")
...
def text_generate():
    ...
    while True:
        ...
        inputs = llm_tokenizer(input, return_tensors="pt", padding=True, truncation=True)
